...
export default function MyBookingsPage() {
    ...
    const fetchBookings = async () => {
        ...
        setLoading(true);
        try {
            const res = await fetch("http://localhost:5003/api/v1/appointments/", {
    ...
    const fetchUserReviews = async () => {
        ...
        try {
            ...
            const res = await fetch("http://localhost:5003/api/v1/users/reviews", {
                headers: { Authorization: `Bearer ${token}` },
                cache: 'no-store',
                method: 'GET'
            });
    ...
    const handleReviewSubmit = async (restaurantId: string) => {
        ...
        try {
            ...
            const url = isEdit
                ? `http://localhost:5003/api/v1/reviews/${userReviews[restaurantId]._id}`
                : `http://localhost:5003/api/v1/restaurants/${restaurantId}/reviews`;
    ...
    const handleDeleteReview = async (reviewId: string) => {
        ...
        try {
            const res = await fetch(`http://localhost:5003/api/v1/reviews/${reviewId}`, {
                method: "DELETE",
                headers: { Authorization: `Bearer ${token}` },
                cache: 'no-store'
            });
